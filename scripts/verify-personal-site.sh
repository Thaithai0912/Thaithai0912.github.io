...
assert_contains "$INDEX_FILE" "<strong>Zhen Leng Thai*</strong>"
assert_contains "$INDEX_FILE" "<strong>Zhen Leng Thai</strong>"
assert_contains "$INDEX_FILE" "<strong>Zhenning Dai</strong>"
assert_contains "$INDEX_FILE" "Between a Rock and a Hard Place"
assert_contains "$INDEX_FILE" "StateX"
assert_contains "$INDEX_FILE" "Cost-Optimal Grouped-Query Attention"
assert_contains "$INDEX_FILE" "DecorateLM"
assert_contains "$INDEX_FILE" "∞Bench"
assert_contains "$INDEX_FILE" "OlympiadBench"
assert_contains "$INDEX_FILE" "ACL 2026"
assert_contains "$INDEX_FILE" "EMNLP 2025"
assert_contains "$INDEX_FILE" "EMNLP 2024"
assert_contains "$INDEX_FILE" "ACL 2024"
assert_contains "$INDEX_FILE" "COLM 2024"
assert_contains "$INDEX_FILE" "* denotes co-first author"
